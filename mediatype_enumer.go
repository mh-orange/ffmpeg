// Code generated by "enumer -type=MediaType -json=true -transform=comment"; DO NOT EDIT.
...
const _MediaTypeName = "videoaudiodatasubtitleattachment"

var _MediaTypeIndex = [...]uint8{0, 5, 10, 14, 22, 32}
...
var _MediaTypeNameToValueMap = map[string]MediaType{
	_MediaTypeName[0:5]:   0,
	_MediaTypeName[5:10]:  1,
	_MediaTypeName[10:14]: 2,
	_MediaTypeName[14:22]: 3,
	_MediaTypeName[22:32]: 4,
}
